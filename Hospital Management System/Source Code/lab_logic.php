    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
        ...
        {   
         ...
         while($record=mysqli_fetch_array($mydata))
         {
             ...
             if($_SESSION['userid']==$lab)
             echo "<tr><td><input type=text style='text-align:center'  name=$date_ch value='$date' size='12'></td><td  style='text-align:center' name=$rep_ch value=$rep size='15'>$rep</td><td><input type=text style='text-align:center'  name=$pat_ch value='$pat' size='15'></td><td><input type=text style='text-align:center'  name=$doc_ch value=$doc size='15'></td><td><input type=text style='text-align:center'  name=$capt_ch value='$capt' size='10'></td><td><input type=text style='text-align:center'  name=$detail_ch value='$detail' size='20'></td><td><input type=submit name=$up_ch value=Update style='background-color:green;font-size:18px;color:white'></td><td><input type=submit name=$del_ch value=Remove style='background-color:red;font-size:18px;color:white'></td></tr>";
             $count=$count+1;
              $rep_ch="rep$count";
            $pat_ch="pat$count";
            $doc_ch="doc$count";
            ...
            $del_ch="del$count";
             ...
             echo "</table>";
             echo "<input type=submit value='Add Report' name='add_pr' style='background-color:blue;font-size:18px;color:white'/>";
                     echo "</div></body></form>"; 
